...
import com.bw.composetodo.components.DisplayAlertDialog
import com.bw.composetodo.components.PriorityItem
import com.bw.composetodo.data.models.Priority
import com.bw.composetodo.ui.theme.LARGE_PADDING
import com.bw.composetodo.ui.theme.TOP_APP_BAR_HEIGHT
...
fun ListAppBarActions(
    ...
    DisplayAlertDialog(
        ...
        message = stringResource(id = R.string.delete_all_tasks_confirm),
...
fun SortAction(
    ...
    IconButton(
        ...
        // immediately notified when expanded changes
        // observing state
        DropdownMenu(
            expanded = expanded,
            // tapping outside menu to dismiss
            onDismissRequest = { expanded = false }
        ) {
            // hide dropdown after selection, set expanded to false
            DropdownMenuItem(
                onClick = {
                    expanded = false
